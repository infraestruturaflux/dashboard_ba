...
def exportar_csv(
    ...
    tipo_ba:     Optional[str]      = Query(None, description="Tipo de BA ou 'Todos'"),
    ...
    if tipo_ba and tipo_ba.lower() not in ("todos", "all", ""):
        query = query.filter(BA.tipo_ba == tipo_ba)
    ...
    # Cabeçalho
    writer.writerow([
        "ID", "Número BA", "Tipo BA", "BA Ofendida", "Operadora",
