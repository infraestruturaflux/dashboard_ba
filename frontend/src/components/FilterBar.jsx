  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <Select
        ...
        onValueChange={(v) => onChange({ ...filtros, operadora: v === "__all__" ? "" : v })}
      >
      ...
      <Select
        value={filtros.cgp || ""}
        onValueChange={(v) => onChange({ ...filtros, cgp: v === "__all__" ? "" : v })}
      >
        <SelectTrigger className="h-8 w-[180px] text-xs">
          <SelectValue placeholder="CGP" />
        </SelectTrigger>
        <SelectContent>
      ...
      <Select
        ...
        onValueChange={(v) => onChange({ ...filtros, status: v === "__all__" ? "" : v })}
      >
      ...
      <Select
        ...
        onValueChange={(v) => onChange({ ...filtros, responsavel: v === "__all__" ? "" : v })}
      >
        <SelectTrigger className="h-8 w-[180px] text-xs">
          <SelectValue placeholder="Responsável Chamado" />
        </SelectTrigger>
        <SelectContent>
